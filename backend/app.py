...
def create_api_app() -> Flask:
    ...
    def get_stats():
        try:
            ...
            fb = FirebaseService()
            # ⚡ Bolt: Using shallow=True to only fetch top-level keys instead of the entire object tree.
            # This drastically reduces payload size and memory usage when counting records.
