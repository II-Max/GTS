...
def create_api_app() -> Flask:
    ...
    def get_stats():
        try:
            ...
            fb = FirebaseService()
            # ⚡ Bolt: Use shallow=True to only fetch top-level keys instead of pulling all nested data.
            # This drastically reduces payload size and memory usage for large collections.
