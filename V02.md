...
**1. Trang đăng nhập mới: `public/login.html`**
...
**2. Trang gateway mới: `public/index.html`**
...
**3. Script kiểm tra auth: `public/js/firebase-auth-check.js`**
...
- Thêm **config/settings.py** với biến môi trường
...
- `public/js/` - Firebase config + auth check
